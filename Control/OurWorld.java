...
public class OurWorld implements World {
    ...
    public OurWorld(Strategy x, int screenWidth, int screenHeight) {
        ...
        flag=true;
        if (!music){
            AudioPlayer audio = AudioPlayer.getInstance("C:\\Users\\farid\\OneDrive\\Desktop\\FINAL FINAL CIRCUS GAME\\CircusGameFinal\\resources\\Circus-Theme-Song.wav");
            audio.play();
            music = true;
       }
    }
    ...
    public boolean refresh() {
        ...
        nIterator = new ObjectIterator(moving);    //right bar
    ...
    private void updateLeftHand() {
        if (leftHand.size() > 0) {
            ...
            if (f instanceof Bomb) {
                ...
                AudioPlayer audio = AudioPlayer.getInstance("C:\\Users\\farid\\OneDrive\\Desktop\\FINAL FINAL CIRCUS GAME\\CircusGameFinal\\resources\\Bomb-Sound.wav");
                audio.play();
                if (chances == 0) {
                    startTime = MAX_TIME;
                }
